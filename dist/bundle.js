...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/SideMenu/SideMenu.css":
/*!*************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/SideMenu/SideMenu.css ***!
  \*************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.todo-ticket-section {\n    height: 450px;\n    overflow: scroll;\n}\n\n.todo-ticket-container {\n    margin: 0;\n    padding: 0;\n    list-style: none;\n}\n", "",{"version":3,"sources":["webpack://./src/TodoTicketsSection/TodoTicketsSection.css"],"names":[],"mappings":";AACA;IACI,aAAa;IACb,gBAAgB;AACpB;;AAEA;IACI,SAAS;IACT,UAAU;IACV,gBAAgB;AACpB","sourcesContent":["\n.todo-ticket-section {\n    height: 450px;\n    overflow: scroll;\n}\n\n.todo-ticket-container {\n    margin: 0;\n    padding: 0;\n    list-style: none;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_SideMenu_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./SideMenu.css */ "./node_modules/css-loader/dist/cjs.js!./src/SideMenu/SideMenu.css");
...
const Header = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    <div>
        <div id="header">TodoList</div>
    </div>
`);

const SubHeader = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    <div id="sub-header">
...
//Bind Events
_pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].on('todolistSelected', function setHeader(selectedTodolist) {
...
for (let link of sortLinks) {
    link.addEventListener('click', (e) => {
        ...
        _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('todolistSelected', selectedTodolist);
    });
}

_pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].on('sortSelected', function(selectedSort) {
    let activeSlide = getActiveSlide();
    delete activeSlide.dataset.active;
    for (let link of sortLinks) {
...
_pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].on('projectSelected', function(selectedProject) {
    for (let link of sortLinks) {
...
const Navbar = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    <div class="navbar"></div>
`);

const hamburgerMenu = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
...
const links = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    <div id="navbar-links">
...
const homeDropdown = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
...
const projectsDropdown = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    <div class="navbar-dropdown-menu"></div>
`);

const createProjectLink = function(project) {
    const projectLink = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
        <div class="navbar-dropdown-menu-links" data-project="${project.name}">${project.name}</div>
    `);
    return projectLink;
}

const searchBar = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    <form id="search-bar">
        <div>
...
const notificationBell = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    <div id="notification-bell">
        <div class="notification-counter"><div>
    </div>
`);

const accountIcon = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    <div id="account-icon"></div>
`);

const navbarContainerLeft = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    <div class="navbar-left-container"></div>
`);

const navbarContainerRight = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
...
hamburgerMenu.addEventListener('click', () => {
    ...
    _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('hamburgerMenuToggled');
});

_pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].on('todoListUpdated', function(todoList) {
...
for (let link of homeDropdown.children) {
    link.addEventListener('click', (e) => {
        _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('projectSelected', '');
        let selectedSort = e.target.dataset.sort;
        _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('sortSelected', selectedSort);
    });
}

_pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].on('projectCreated', function(newProject) {
    ...
    newProjectLink.addEventListener('click', (e) => {
        ...
        _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('projectSelected', selectedTodolist.selectedProject);
        _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('todolistSelected', selectedTodolist);
    });
});
...
/* harmony import */ var _SideMenu_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SideMenu.css */ "./src/SideMenu/SideMenu.css");
...
const SideMenu = (function() {
    ...
    //Bind Events
    _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].on('hamburgerMenuToggled', function openSideMenu() {
    ...
    _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].on('setDate', function updateTodayIcon(todaysDate) {
        todayIcon.textContent = todaysDate;
    });

    _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].on('projectUpdated', function updateProjectQuantities(project) {
    ...
    _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].on('projectDeleted', function(project) {
        for (let link of projectLinks.children) {
            if (link.id === project.id) {
    ...
    _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].on('todoListUpdated', function updateQuantities(todoList) {
    ...
    _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].on('projectCreated', function(newProject) {
        let newProjectLink = createProjectLink(newProject);
    ...
    for (let link of mainLinks.children) {
        link.addEventListener('click', function selectSort(e) {
            _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].emit('projectSelected', '');
            let selectedSort = e.target.closest('.side-menu-links').dataset.sort;
            _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].emit('sortSelected', selectedSort);
        });
    }
...
function createProjectLink(project) {
    ...
    projectLink.addEventListener('click', (e) => {
        ...
        _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].emit('projectSelected', selectedTodolist.selectedProject);
        _pub_sub__WEBPACK_IMPORTED_MODULE_1__["default"].emit('todolistSelected', selectedTodolist);
    });
...
function TodoTicket(todoData) {
    ...
    const topContainer = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    ...
    const bottomContainer = (0,_global_functions__WEBPACK_IMPORTED_MODULE_1__.createHTML)(`
    ...
    todoCompletedButton.addEventListener('click', () => {
        ...
        setTimeout(function() {
            ...
            _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('todoTicketDeleted', todoData);
        }, 500);
    });
    ...
    todoTicketSubmitButton.addEventListener('click', (e) => {
        ...
        resetForm();
        _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('projectSubmitted', editedTodoData.project);
        _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('todoSubmitted', editedTodoData);
    });

    _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].on('todoDataEdited', function(todoClone) {
...
function TodoTicketsForm() {
    ...
    //Bind Events
    _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].on('setTime', function(nextHour) {
    ...
    addTodoFormSubmitButton.addEventListener('click', (e) => {
        ...
        _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('projectSubmitted', newTodoData.project);
        _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].emit('todoSubmitted', newTodoData);
...
const TodoTicketsSection = (function() {
    ...
    // Bind Events
    _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].on('todoCreated', function(newTodo) {
    ...
    _pub_sub__WEBPACK_IMPORTED_MODULE_2__["default"].on('displayTodoList', function(todoList) {
...
class TodoList {
    ...
    dueToday() {
        let dueToday = this.all.filter(todo => {
            ...
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(todosDate)) {
                return todo;
            }
        });
        dueToday.sort((a, b) => 
...
class Todo {
    ...
    pastDue() {
        const todo_Hmm = parseInt((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(`1/1/1111 ${this.time}`), 'H:mm'));
        const todo_mm = parseInt((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(`1/1/1111 ${this.time}`), 'mm'));
        const rn_Hmm = parseInt((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'H:mm'));
        const rn_mm = parseInt((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'mm'));
        if (
        ...
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(`${this.date} ${this.time}`));
    }
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/addSeconds/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/endOfHour/index.js");
...
/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utility */ "./src/data/utility.js");
/* harmony import */ var _data_structure__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data-structure */ "./src/data/data-structure.js");





const todoList = new _data_structure__WEBPACK_IMPORTED_MODULE_2__.TodoList();
const projects = [];
...
window.addEventListener('load', () => {
    ...
    todoListAllClone.forEach(todo => {
        if (todo.project) {
            _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('projectSubmitted', todo.project);
        }
        todo.type = 'Create';
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('todoSubmitted', todo);
    });
});

    //Todos
_pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].on('todoSubmitted', function parseDateTime(todoData) {
    // Convert Date to Acceptable Format
    if (todoData.date === '') {
        todoData.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'M/d/yyyy');
    } else {
        todoData.date = (0,_utility__WEBPACK_IMPORTED_MODULE_1__.inputConverter)(todoData.date);
    }
    // Set Default Time (if no time is given)
    if (todoData.time === '' && (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(todoData.date))) {
        let nextHour = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date()), 1), 'H:mm');
        todoData.time = nextHour;
    } else if (todoData.time === '' && !(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(todoData.date))) {
        let nextHour = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date()), 1), 'H:mm');
        todoData.time = nextHour;
    }
    // Validate Date & Time 
    if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(`${todoData.date} ${todoData.time}`))) {
        return;
    }

    let dateTime = new Date(`${todoData.date} ${todoData.time}`);
    todoData.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(dateTime), 'M/d/yyyy');
    todoData.time = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(dateTime), 'h:mm a');

    if (todoData.type === 'Create') {
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('date&timeInputParsed-CreateTodo', todoData);
    }
    if (todoData.type === 'Update') {
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('date&timeParsed-UpdateTodo', todoData);
    }
});

_pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].on('date&timeInputParsed-CreateTodo', function createTodo(newTodoData) {
    const newTodoId = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'MM/dd/yyyy HH:mm:ss:SSSS');
    ...
    let newTodo = new _data_structure__WEBPACK_IMPORTED_MODULE_2__.Todo(
        newTodoId,
        newTodoData.task,
        newTodoData.date,
        newTodoData.time,
    ...
    if (newTodoData.project !== '') {
        for (let i = 0; i < projects.length; i++) {
            if (newTodoData.project.toLowerCase() === projects[i].name.toLowerCase()) {
                ...
                _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('projectUpdated', projects[i]);
            }
        }
    }
    ...
    newTodoClone.date = (0,_utility__WEBPACK_IMPORTED_MODULE_1__.dateConverter)(newTodoData.date);

    _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('todoListUpdated', todoList);
    _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('todoCreated', newTodoClone);
});

_pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].on('date&timeParsed-UpdateTodo', function(editedTodoData) {
        ...
        if (todo.id === editedTodoData.id) {
            ...
            projects.forEach(project => {
                if (project.id === todo.projectId) {
                    ...
                    _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('todoDeleted-Project', project);
                    _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('projectUpdated', project);
                }
            });
            ...
            todoClone.date = (0,_utility__WEBPACK_IMPORTED_MODULE_1__.dateConverter)(editedTodoData.date);

            _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('todoListUpdated', todoList);
            _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('todoDataEdited', todoClone);
            return;
        }
    });
});

_pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].on('todoTicketDeleted', function(todoTicketData) {
    ...
    if (todoTicketData.project) {
        ...
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('todoDeleted-Project', todosProject);
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('projectUpdated', todosProject);
    }
});

    //Projects
_pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].on('projectSubmitted', function(projectName) {
    if (projectName !== '') {
        for (let i = 0; i < projects.length; i++) {
        ...
        const newProjectId = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'm/d/yyyy HH:mm:ss:SSSS');
        let newProject = new _data_structure__WEBPACK_IMPORTED_MODULE_2__.Project(projectName, newProjectId);
        projects.push(newProject);

        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('projectCreated', newProject);
    }
});

_pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].on('todoDeleted-Project', function(project) {
    if (project.all.length === 0) {
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('projectDeleted', project);
    ...
    //TodoList
_pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].on('todolistSelected', function displayTodos(selectedTodolist) {
    function cloneTodoList(todoList) {
        let todoListClone = new _data_structure__WEBPACK_IMPORTED_MODULE_2__.TodoList;
        todoList.all.forEach(todo => {
            let todoClone = cloneTodo(todo);
    ...
    if (selectedTodolist.selectedSort === 'All') {
        todoListClone.all.forEach(todo => {
            todo.date = (0,_utility__WEBPACK_IMPORTED_MODULE_1__.dateConverter)(todo.date);
        });

        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('displayTodoList', todoListClone.all);
    ...
    if (selectedTodolist.selectedSort === 'Today') {
        ...
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('displayTodoList', dueToday);
    ...
    if (selectedTodolist.selectedSort === 'Upcoming') {
        ...
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('displayTodoList', upcoming);
    ...
    if (selectedTodolist.selectedSort === 'Important') {
        ...
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('displayTodoList', important);
    ...
    if (selectedTodolist.selectedSort === 'Favorites') {
        ...
        _pub_sub__WEBPACK_IMPORTED_MODULE_0__["default"].emit('displayTodoList', favorites);
...
function cloneTodo(todo) {
    let todoClone = new _data_structure__WEBPACK_IMPORTED_MODULE_2__.Todo(
        todo.id,
        todo.task,
        todo.date,
        todo.time,
...
/* harmony export */   "inputConverter": () => (/* binding */ inputConverter)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isToday/index.js");
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isSunday/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isMonday/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isTuesday/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isWednesday/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isThursday/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isFriday/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isSaturday/index.js");


function dateConverter(date) {
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(date))) {
        return 'Today';
    }

    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(date)) && !(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(date))) {
...
function inputConverter(input) {
    if (input === 'today') {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'M/d/yyyy');
    }

    if (input === 'tomorrow') {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), 1), 'M/d/yyyy');
    }

    if (input === 'sunday') {
        for (let i = 0; i < 7; i++) {
            let day = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), i);
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(day)) {
                return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(day), 'M/d/yyyy');
            }
        }
    }
    ...
    if (input === 'monday') {
        for (let i = 0; i < 7; i++) {
            let day = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), i);
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(day)) {
                return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(day), 'M/d/yyyy');
            }
        }
    }
    ...
    if (input === 'tuesday') {
        for (let i = 0; i < 7; i++) {
            ...
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(day)) {
                return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(day), 'M/d/yyyy');
            }
        }
    }
    ...
    if (input === 'wednesday') {
        for (let i = 0; i < 7; i++) {
            ...
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(day)) {
                return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(day), 'M/d/yyyy');
            }
        }
    }
    ...
    if (input === 'thursday') {
        for (let i = 0; i < 7; i++) {
            ...
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(day)) {
                return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(day), 'M/d/yyyy');
            }
        }
    }
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/addSeconds/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/endOfHour/index.js");
/* harmony import */ var _Navbar_Navbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Navbar/Navbar */ "./src/Navbar/Navbar.js");
/* harmony import */ var _SideMenu_SideMenu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SideMenu/SideMenu */ "./src/SideMenu/SideMenu.js");
...
/* harmony import */ var _data_todos__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./data/todos */ "./src/data/todos.js");
/* harmony import */ var _pub_sub__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pub-sub */ "./src/pub-sub.js");
...
let homePage = [
    ...
    _SideMenu_SideMenu__WEBPACK_IMPORTED_MODULE_2__["default"], 
    _Header_Header__WEBPACK_IMPORTED_MODULE_3__["default"], 
    _TodoTicketsSection_TodoTicketsSection__WEBPACK_IMPORTED_MODULE_4__["default"],
];

// Events
window.addEventListener('load', () => {
    let todaysDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), 'd');
    let nextHour = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(new Date()), 1), 'h:mm a');
    _pub_sub__WEBPACK_IMPORTED_MODULE_6__["default"].emit('setDate', todaysDate);
    _pub_sub__WEBPACK_IMPORTED_MODULE_6__["default"].emit('setTime', nextHour);
});
